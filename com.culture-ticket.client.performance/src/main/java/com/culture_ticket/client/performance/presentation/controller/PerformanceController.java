...
public class PerformanceController {
    ...
    public ResponseMessageDto createPerformanceDomain(
        ...
        performanceDomainService.createPerformanceDomain(username, role,
            performanceDomainCreateRequestDto);
    ...
    public ResponseDataDto<PerformanceResponseDto> getPerformance(
        ...
        PerformanceResponseDto performanceResponseDto = performanceService.getPerformance(
            request.getSession().getId(), performanceId);
        return new ResponseDataDto<>(ResponseStatus.GET_PERFORMANCE_SUCCESS,
    ...
    public ResponseDataDto<RestPage<PerformanceResponseDto>> getPerformances(
        ...
        RestPage<PerformanceResponseDto> performances = performanceService.getPerformances(
            condition, keyword, pageable);
